...
| 17. | esignet.sandbox.xyz.net    | Public IP of Nginx server for MOSIP cluster                           | Accessing eSignet portal publically                                                                                                                                                                                         |
| 18. | healthservices.sandbox.xyz.net    | Public IP of Nginx server for MOSIP cluster                    | Accessing Health portal publically                                                                                                                                                                                         |
